  ...
  return (
    <div style={{ height: '100vh', background: '#0a0a0f', overflow: activeTab === 'trades' ? 'hidden' : 'auto' }} onMouseMove={e => setMousePos({ x: e.clientX, y: e.clientY })}>
      ...
      {!isMobile && (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '55px' }}>
          {['trades', 'statistics', 'notes'].map((tab) => (
            <button
              key={tab}
      ...
      {/* MAIN CONTENT */}
      <div style={{ marginLeft: isMobile ? 0 : '180px', marginTop: isMobile ? '100px' : '120px', padding: isMobile ? '12px' : '0' }}>
