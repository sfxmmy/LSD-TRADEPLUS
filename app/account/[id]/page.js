                              ...
                              <>
                                ...
                                <div style={{ flex: 1, display: 'flex' }}>
                                  ...
                                  <div style={{ flex: 1, position: 'relative', overflow: 'visible', borderBottom: '1px solid #2a2a35' }}>
                                    ...
                                    {startLineY !== null && (
                                      <div style={{ position: 'absolute', left: 0, right: '3%', top: `${startLineY}%`, borderTop: '1px dashed #666', zIndex: 1 }} />
                                    )}
                  ...
                  <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex' }}>
                      ...
                      <div style={{ flex: 1, position: 'relative', overflow: 'visible', borderBottom: '1px solid #2a2a35' }}>
                          ...
                          {equityCurveGroupBy === 'total' && startYEnl >= 0 && startYEnl <= svgH && (
                            <>
                              <div style={{ position: 'absolute', left: 0, right: '3%', top: `${(startYEnl / svgH) * 100}%`, borderTop: '1px dashed #666', transform: 'translateY(-50%)', zIndex: 1 }} />
