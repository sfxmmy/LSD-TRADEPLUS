    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0f' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 20px' }}>
        <div style={{ background: '#14141a', border: '1px solid #222230', borderRadius: '20px', padding: '40px', width: '420px', textAlign: 'center' }}>
          ...
          <p style={{ color: '#999', fontSize: '14px', marginBottom: '24px' }}>Free access for TRADESAVE+ Discord members</p>
          ...
          <button onClick={handleDiscordLogin} disabled={loading} style={{ width: '100%', padding: '16px', background: loading ? '#4752C4' : '#5865F2', border: 'none', borderRadius: '10px', color: '#fff', fontWeight: 600, fontSize: '16px', cursor: loading ? 'not-allowed' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
          ...
          <div style={{ marginTop: '24px', padding: '16px', background: '#0a0a0f', borderRadius: '10px' }}>
            <p style={{ color: '#999', fontSize: '13px', lineHeight: 1.6 }}>
              <strong style={{ color: '#999' }}>Note:</strong> You must be a member of the TRADESAVE+ Discord server. Not a member? <a href="/signup" style={{ color: '#22c55e' }}>Sign up</a> for a paid account.
            </p>
          </div>
        </div>
      </div>
