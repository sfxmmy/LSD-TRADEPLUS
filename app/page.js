...
export default function LandingPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', overflow: 'hidden', background: '#0a0a0f' }}>
      {/* Header */}
      ...
      {/* Hero */}
      <section style={{ padding: '60px 48px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '20px' }}>
        {/* Left side image */}
        ...
        <div style={{ maxWidth: '750px', border: '1px solid #2a2a35', borderRadius: '20px', padding: '50px 40px', textAlign: 'center', background: '#0a0b0e' }}>
          <h1 style={{ fontSize: '52px', fontWeight: 800, lineHeight: 1.15, marginBottom: '16px', color: '#fff' }}>
            The Trading Journal
          </h1>
      ...
      <section style={{ padding: '40px 48px', background: '#0d0d12' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '36px', fontWeight: 700, textAlign: 'center', marginBottom: '40px', color: '#fff' }}>Everything You Need</h2>
      ...
      <section id="how-it-works" style={{ padding: '40px 48px' }}>
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <h2 style={{ fontSize: '36px', fontWeight: 700, textAlign: 'center', marginBottom: '40px', color: '#fff' }}>How It Works</h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '32px' }}>
            {[
              ...
              <div key={i} style={{ textAlign: 'center' }}>
                <div style={{ width: '100%', aspectRatio: '4/3', background: '#14141a', border: '1px solid #2a2a35', borderRadius: '16px', marginBottom: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <span style={{ color: '#555', fontSize: '14px' }}>Image {item.step}</span>
                </div>
                <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '36px', height: '36px', background: '#22c55e', borderRadius: '50%', fontWeight: 700, fontSize: '16px', marginBottom: '12px', color: '#fff' }}>{item.step}</div>
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ background: 'linear-gradient(135deg, #14141a 0%, #1a2a1a 100%)', border: '2px solid #22c55e', borderRadius: '16px', padding: '32px', textAlign: 'left', position: 'relative' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '32px' }}>
              {['Unlimited Journals', 'Advanced Statistics', 'Unlimited Trades', 'Custom Fields', 'Priority Support', 'Data Stored Forever'].map((f, i) => (
                <li key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#bbb', fontSize: '14px' }}><CheckIcon /> {f}</li>
              ))}
            </ul>
            <button onClick={handleSubscribe} style={{ width: '100%', padding: '14px', background: '#22c55e', border: 'none', borderRadius: '10px', color: '#fff', fontWeight: 700, cursor: 'pointer' }}>
              Subscribe Now
            </button>
          </div>
        </div>
