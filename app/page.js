    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0f' }}>
      ...
      <header style={{ padding: '4px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #1a1a22' }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          ...
          <a href="/login" style={{ padding: '8px 16px', background: 'transparent', border: '1px solid #2a2a35', borderRadius: '6px', color: '#fff', fontWeight: 600, fontSize: '13px', textDecoration: 'none' }}>
            Member Log In
          </a>
        </div>
      </header>
      ...
      <footer style={{ padding: '24px', borderTop: '1px solid #1a1a22', textAlign: 'center' }}>
        <p style={{ color: '#555', fontSize: '14px' }}>© 2024 TRADESAVE+. All rights reserved.</p>
      </footer>
    </div>
  )
}
