    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0f' }}>
      <header style={{ padding: '4px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #1a1a22' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          {!loading && hasAccess ? (
            <a href="/dashboard" style={{ padding: '8px 16px', background: '#22c55e', borderRadius: '6px', color: '#fff', fontWeight: 600, fontSize: '13px', textDecoration: 'none' }}>Enter Journal</a>
          ) : (
            <>
              <a href="/login" style={{ padding: '8px 16px', background: 'transparent', border: 'none', color: '#999', fontSize: '13px', textDecoration: 'none' }}>Login</a>
              <a href="/signup" style={{ padding: '8px 16px', background: '#22c55e', borderRadius: '6px', color: '#fff', fontWeight: 600, fontSize: '13px', textDecoration: 'none' }}>Sign Up</a>
            </>
          )}
        </div>
      </header>
